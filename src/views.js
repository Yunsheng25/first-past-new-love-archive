...
function buildIntroNavigation() {
  return navItems
    .map(([href, label]) => `<a href="${href}" data-character-motion>${label}<i aria-hidden="true"></i></a>`)
    .join('');
}
  ...
  return `
    <section class="intro-view app-view" aria-labelledby="intro-title">
      ...
      <div class="intro-hero">
        <p class="hero-eyebrow" data-cinematic-entry style="--entry-delay:.2s">MEMORY <span aria-hidden="true">·</span> CHOICE <span aria-hidden="true">·</span> AFTERWARDS</p>
        <h1 id="intro-title" class="hero-title">
          <span data-character-motion>初恋</span><b aria-hidden="true">·</b><span data-character-motion>旧爱</span><b aria-hidden="true">·</b><span data-character-motion>新欢</span>
        </h1>
        ...
        <p class="hero-statement" data-character-motion data-cinematic-entry style="--entry-delay:.8s">每一段情感，都是时光里的一次遇见</p>
  ...
  return `
    <section class="after-view app-view" aria-labelledby="after-title">
      ...
      <div class="after-content">
        ...
        <h1 id="after-title" data-character-motion data-cinematic-entry>影片已结束</h1>
        <p class="after-prompt" data-character-motion data-cinematic-entry style="--entry-delay:.2s">选择继续阅读的方向</p>
        ...
        <nav class="after-choices" aria-label="影片结束后的阅读选择">
          <a class="after-choice" href="#review" data-after-primary>
            ...
            <span class="after-choice-title" data-character-motion>复盘手记</span>
          ...
          <a class="after-choice" href="#archive" data-after-primary>
            ...
            <span class="after-choice-title" data-character-motion>提示词和图片</span>
